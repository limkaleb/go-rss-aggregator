...
import (
	...
	"github.com/limkaleb/rssaggregator/internal/database"
)

func startScraping(
	db *database.Queries,
	concurrency int, // how many different goroutine
	timeBetweenRequest time.Duration, // how much time inbetween request
) {
